...
public class StickerPackListAdapter extends RecyclerView.Adapter<StickerPackListItemViewHolder> implements Filterable {
    ...
    StickerPackListAdapter(@NonNull List<Sticker_packs> stickerPacks, @NonNull OnAddButtonClickedListener onAddButtonClickedListener, Context mcontext) {
        this.stickerPacks = stickerPacks;
        this.stickerPacksFiltred = stickerPacks;
        this.onAddButtonClickedListener = onAddButtonClickedListener;
        admobObj = new AdmobAdsClass();
        admobObj.loadIntrestrialAds(mcontext);
    }
    ...
    public void onBindViewHolder(@NonNull final StickerPackListItemViewHolder viewHolder, final int index) {
        try {
            ...
            viewHolder.container.setOnClickListener(view -> {
               ...
               /* admobObj.showIntrestrialAds(context, new admobCloseEvent() {
                    @Override
